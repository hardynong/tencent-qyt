...
| ClickID |否| string  | ClickID |
| PageType |是| int32  | 落地页类型,1:线索,2:领券 |
| CouponAmount |否|   int32  | 购券金额     |
| CouponDetail |否|   []String  | 优惠券信息     |
...
clikc id 定义：对于推广Web落地页而言，在腾讯广告推广时，每次点击都会生成一个 click_id，在跳转到落地页时，会将 click_id 作为参数传入对应的 URL 中。对于腾讯广告非微信流量为URL中的参数qz_gdt的值，对于微信流量为URL中的参数gdt_vid的值。
...
请求小程序参数接口地址：https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onLoad-Object-query
